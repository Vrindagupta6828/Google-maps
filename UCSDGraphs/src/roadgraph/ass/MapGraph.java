...
public class MapGraph{
	...
	public static void main(String[] args)
	{
		...
		List<GeographicPoint> sroute = firstMap.dijkstra(new GeographicPoint(1.0, 1.0), new GeographicPoint(8.0, -1.0));
		System.out.println(sroute);
		
		List<GeographicPoint> aroute = firstMap.aStarSearch(new GeographicPoint(1.0, 1.0), new GeographicPoint(8.0, -1.0));
